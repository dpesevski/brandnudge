CREATE FOREIGN TABLE PROD_FDW."coreProductCountryData"
    (
    ...
    SERVER PRODDB_FDW
    OPTIONS (schema_name 'public', table_name 'coreProductCountryData');

ALTER FOREIGN TABLE PROD_FDW."coreProductCountryData"
    OWNER TO POSTGRES;
