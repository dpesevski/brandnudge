CREATE FOREIGN TABLE PRODDB_STAGING_FDW.DEBUG_PRODUCTSDATA
    (
    ...
    SERVER PRODDB_FDW
    OPTIONS (schema_name 'staging', table_name 'debug_productsdata');

ALTER FOREIGN TABLE PRODDB_STAGING_FDW.DEBUG_PRODUCTSDATA
    OWNER TO POSTGRES;
