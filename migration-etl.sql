...
BEGIN
    ...
    IF flag = 'create-products' THEN
        ...
        ELSE
            PERFORM staging.load_retailer_data_base_new(fetched_data, _debug_test_run_id);
        END IF;
...
DROP FUNCTION IF EXISTS staging.load_retailer_data_base_new(json, integer);
CREATE OR REPLACE FUNCTION staging.load_retailer_data_base_new(value json, debug_test_run_id integer DEFAULT NULL) RETURNS void
    LANGUAGE plpgsql
AS
$$
DECLARE
