CREATE TABLE data_corr.ms2_data_corr_status_deleted_products
(
    id                      integer,
...
ALTER TABLE data_corr.ms2_data_corr_status_deleted_products
    OWNER TO postgres;

GRANT SELECT ON data_corr.ms2_data_corr_status_deleted_products TO bn_ro;

GRANT SELECT ON data_corr.ms2_data_corr_status_deleted_products TO dejan_user;
